...
<div class="navbar" role="navigation">
    ...
    <div class="container-fluid">
        ...
        <div class="copyrights">Collect from <a href="http://greenbay.usc.edu/csci577/fall2016/projects/team10">Team
                10</a></div>
        ...
        <div class="sidebar ">
                    ...
                    <div class="sidebar-menu">
                        <ul class="nav nav-sidebar">
                            ...
                            <li>
                                ...
                                <ul class="nav sub">
                                    <li><a href=""><i class="fa fa-car"></i><span class="text"> Activity</span></a></li>
                                    <li><a href=""><i class="fa fa-envelope"></i><span class="text"> Mail</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-credit-card"></i><span
                                                    class="text"> Invoice</span></a></li>
                                    <li><a href=""><i class="fa fa-heart-o"></i><span class="text"> Profile</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-columns"></i><span
                                                    class="text"> Pricing Tables</span></a></li>
                                    <li><a href=""><i class="fa fa-puzzle-piece"></i><span class="text"> 404</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-puzzle-piece"></i><span class="text"> 500</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-lock"></i><span class="text"> LockScreen1</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-lock"></i><span class="text"> LockScreen2</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-key"></i><span class="text"> Login Page</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-sign-in"></i><span class="text"> Register Page</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href=""><i class="fa fa-list-alt"></i><span class="text"> Forms</span> <span
                                            class="fa fa-angle-down pull-right"></span></a>
                                <ul class="nav sub">
                                    <li><a href=""><i class="fa fa-indent"></i><span class="text"> Form elements</span></a>
                                    </li>
                                    <li><a href=""><i class="fa fa-tags"></i><span
                                                    class="text"> Wizard</span></a></li>
                                    <li><a href=""><i class="fa fa-plus-square-o"></i><span
                                                    class="text"> Dropzone Upload</span></a></li>
                                    <li><a href=""><i class="fa fa-pencil"></i><span class="text"> X-editable</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href=""><i class="fa fa-table"></i><span class="text"> Tables</span></a>
                            </li>
                            <li>
            ...
            <div class="sidebar-footer">
                ...
                <div class="copyright text-center">
                    <small><i class="fa fa-folder"></i> E-Lockbox from <a
